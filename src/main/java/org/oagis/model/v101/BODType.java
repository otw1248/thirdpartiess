 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.openapplications.org/oagis/10}BODBaseType">
 *       &lt;sequence>
 *         &lt;element name="Extension" type="{http://www.openapplications.org/oagis/10}BODExtensionType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends BODBaseType
{
    ...
    protected List<BODExtensionType> extension;
     ...
     * {@link BODExtensionType }
     * 
     * 
     */
    public List<BODExtensionType> getExtension() {
        if (extension == null) {
            extension = new ArrayList<BODExtensionType>();
        }
