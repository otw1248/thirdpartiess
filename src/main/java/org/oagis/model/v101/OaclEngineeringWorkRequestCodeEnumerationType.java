...
/**
 * <p>Java class for oacl_EngineeringWorkRequestCodeEnumerationType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="oacl_EngineeringWorkRequestCodeEnumerationType">
 ...
 * 
 */
@XmlType(name = "oacl_EngineeringWorkRequestCodeEnumerationType")
@XmlEnum
public enum OaclEngineeringWorkRequestCodeEnumerationType {
    ...
    OaclEngineeringWorkRequestCodeEnumerationType(String v) {
        value = v;
    }
    ...
    public static OaclEngineeringWorkRequestCodeEnumerationType fromValue(String v) {
        for (OaclEngineeringWorkRequestCodeEnumerationType c: OaclEngineeringWorkRequestCodeEnumerationType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
