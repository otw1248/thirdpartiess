...
/**
 * <p>Java class for oacl_RiskTypeEnumerationType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="oacl_RiskTypeEnumerationType">
 ...
 * 
 */
@XmlType(name = "oacl_RiskTypeEnumerationType")
@XmlEnum
public enum OaclRiskTypeEnumerationType {
    ...
    OaclRiskTypeEnumerationType(String v) {
        value = v;
    }
    ...
    public static OaclRiskTypeEnumerationType fromValue(String v) {
        for (OaclRiskTypeEnumerationType c: OaclRiskTypeEnumerationType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
